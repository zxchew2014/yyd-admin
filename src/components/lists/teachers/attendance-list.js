            ...
            attendances.map(attendance => {
                return (
                    <Table.Row textAlign="center" key={attendance}>
                        <Table.Cell>{attendance.clockIn && moment(attendance.clockIn, 'DD/MM/YYYY, HH:mm:ss').format('ddd MMM DD YYYY') || moment(attendance.clockOut, 'DD/MM/YYYY, HH:mm:ss').format('ddd MMM DD YYYY')}</Table.Cell>
                        <Table.Cell>{attendance.clockIn && moment(attendance.clockIn, 'DD/MM/YYYY, HH:mm:ss').format('LT') || ""}</Table.Cell>
                        <Table.Cell>{attendance.clockOut && moment(attendance.clockOut, 'DD/MM/YYYY, HH:mm:ss').format('LT') || ""}</Table.Cell>
